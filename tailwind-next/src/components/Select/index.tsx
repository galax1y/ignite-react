    ...
    <SelectPrimitive.Root {...props}>
      ...
      <SelectPrimitive.Portal>
        <SelectPrimitive.Content
          ...
          sideOffset={8}
          position="popper"
          className="z-10 w-[--radix-select-trigger-width] animate-slideDownAndFade rounded-lg border border-zinc-200 bg-white shadow-sm dark:border-zinc-400 dark:bg-zinc-800"
        >
