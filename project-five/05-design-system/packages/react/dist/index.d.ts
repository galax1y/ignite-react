...
declare const Provider$1: _stitches_react_types_styled_component.StyledComponent<react.FC<Tooltip$1.TooltipProviderProps>, {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        gray100: string;
...
interface TooltipProviderProps extends ComponentProps<typeof Provider$1> {
}
...
declare const Provider: _stitches_react_types_styled_component.StyledComponent<react.FC<Toast$1.ToastProviderProps>, {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        gray100: string;
...
export { Avatar, AvatarProps, Box, BoxProps, Button, ButtonProps, Checkbox, CheckboxProps, Heading, HeadingProps, MultiStep, MultiStepProps, Text, TextArea, TextAreaProps, TextInput, TextInputProps, TextProps, Toast, ToastProps, ToastProvider, Tooltip, TooltipProps, TooltipProvider, TooltipProviderProps };
